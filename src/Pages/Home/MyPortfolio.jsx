      ...
      <div className="portfolio--section--container">
          <div  className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src="./img/ecoo.jpg" alt="Placeholder" />
            </div>
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">onlineShoping</h3>
                <p className="text-md">In the fast-paced digital age, the convenience of online shopping has revolutionized the way we purchase goods, including clothing With the emergence of e-commerce platforms, consumers now have access to a vast array of fashion choices from the comfort of their own homes</p>
              </div>
              <a className="text-sm portfolio--link" href="https://github.com/21g21g/online-cloth-shoping" target="_blank">
          ...
          <div  className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src="./img/intern.jpg" alt="Placeholder" />
            </div>
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Internship Portal</h3>
                <p className="text-md">The Internship Portal is a dynamic platform designed to bridge the gap between students and companies. This project facilitates seamless connections, enabling students to find valuable internship opportunities while helping companies discover fresh talent. With user-friendly features and a focus on accessibility, the Internship Portal enhances the internship search experience, fostering mutually beneficial relationships between students and businesses.</p>
              </div>
              <a className="text-sm portfolio--link" href="https://github.com/21g21g/internship" target="_blank">
          ...
          <div  className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src="./img/tourism.jpg" alt="Placeholder" />
            </div>
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">ExploreEthiopia</h3>
                <p className="text-md">ExploreEthiopia is an engaging platform dedicated to showcasing the rich cultural heritage, breathtaking landscapes, and diverse attractions of Ethiopia. This project provides users with detailed travel guides, historical insights, and curated itineraries, making it easy for tourists and locals alike to discover and explore the beauty of Ethiopia.</p>
              </div>
              <a className="text-sm portfolio--link" href="https://github.com/21g21g/ethioExplore" target="_blank">
